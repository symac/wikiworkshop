...
<head>
    ...
    –––––––––––––––––––––––––––––––––––––––––––––––––– -->
    <meta charset="utf-8">
    <title>Préparation atelier - conseils</title>
...
<div class="container">
    <div class="row">
        <div id="conseils">
            <h1><a href="index.php">&#127968;</a> > Conseils</h1>
            <p>Lors d'un atelier d'initiation à Wikipédia il n'est pas toujours simple de trouver des modifications simples à proposer à des personnes qui n'ont jamais contribué.</p>

            <p>Cet outil vise à proposer une solution simple pour identifier des articles comprenant des fautes d'orthographe basique qu'une personne pourra aller corriger pour faire sa première contributionà wikipédia. </p>

            <p>Quelques premiers retours d'expérience sur cet outil :</p>
            <ul>
